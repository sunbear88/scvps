...
# // Make Config Link
#vless_nontls3="vless://${uuid}@cdn.who.int:${nontls_port}?path=cdn.who.int&security=none&encryption=none&host=${domain}&headerType=none&type=ws&quicSecurity=none#${Username}";
vless_nontls2="vless://${uuid}@104.17.113.188:${nontls_port}?path=/vless&security=none&encryption=none&host=cdn.who.int.${domain}&type=ws#${Username}";
...
vless_nontls1="vless://${uuid}@${IP_NYA}:${nontls_port}?path=/vless&security=none&encryption=none&host=www.who.int&type=ws#${Username}";
vless_nontls3="vless://${uuid}@${IP_NYA}:${nontls_port}?path=/vless&security=none&encryption=none&host=cd.who.int&type=ws#${Username}";
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG YES TIADA DATA" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls2}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG YES ADA DATA" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " ${vless_nontls1}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG YES LATEST" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
