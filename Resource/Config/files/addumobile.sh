...
vless_tls1="vless://${uuid}@${IP_NYA}:${tls_port}?security=tls&encryption=none&type=ws&headerType=none&path=/vless&sni=www.pubgmobile.com#${Username}";
vless_tls2="vless://${uuid}@${IP_NYA}:${tls_port}?security=tls&encryption=none&type=ws&headerType=none&path=/vless&sni=opensignal.com#${Username}";
vless_tls3="vless://${uuid}@${IP_NYA}:${tls_port}?security=tls&encryption=none&type=ws&headerType=none&path=/vless&sni=pay-dcb.u.com.my#${Username}";
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UMOBILE PUBG FUNZ" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
