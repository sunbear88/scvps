...
vless_tls2="vless://${uuid}@ecommerce.unifi.com.my.${domain}:${tls_port}?path=%2Fvless&security=tls&encryption=none&type=ws&sni=ecommerce.unifi.com.my#${Username}";
...
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UNIFI PLAYTV" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " ${vless_tls}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e "${CYAN}════════════════════════════════════════════${NC}" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
echo -e " LINK CONFIG UNIFI ECOMMERCE" | tee -a /etc/sunbearvpn/vless/${Username}/config.log;
